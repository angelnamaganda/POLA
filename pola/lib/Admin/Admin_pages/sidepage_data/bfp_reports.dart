...
import 'package:pola/Admin/displays/bfp.dart';
import 'package:logger/logger.dart';

class BfpReports extends StatefulWidget {
  const BfpReports({super.key});

  @override
  State<BfpReports> createState() => _BfpReportsState();
}

class _BfpReportsState extends State<BfpReports> {
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Column(
            children: [
             StreamBuilder(
                stream: FirebaseFirestore.instance.collection('bfp_reports').where('username', isNotEqualTo: null)
