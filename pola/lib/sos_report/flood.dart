...
class FloodReports extends StatefulWidget {
  const FloodReports({super.key});

  @override
  State<FloodReports> createState() => _ReportsState();
}

class _ReportsState extends State<FloodReports> {
  ...
  Future<void> getCurrentUserName() async{
   ...
   void savePost() async{
    ...
    final Reference storageReference = FirebaseStorage.instance.ref().child('flood_image/${DateTime.now()}.jpg');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text('Flood Incident Report',
        style: TextStyle(
          color: Colors.white,
          fontSize: 16
        ),),
